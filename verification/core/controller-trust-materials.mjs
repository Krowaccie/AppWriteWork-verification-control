...
import { validateTestCloudSetupReadbackBytes } from '../../verification/adapters/test-cloud/test-cloud-provider-contract.mjs';
import { validateTestCloudSetupAttestationDocument } from '../../verification/adapters/test-cloud/test-cloud-setup-attestation.mjs';
...
export function validatePublishedControllerTrustArtifacts(args) {
  try {
    ...
    if (
      ...
      || evaluator.entrypoint !== 'verification/core/controller-trust-materials.mjs'
