...
const SOURCE_SET_DESCRIPTOR_PATH = 'verification/controller/controller-seed-source-sets.v1.json';
const SOURCE_SET_DESCRIPTOR_SCHEMA_PATH = 'verification/schemas/controller-seed-source-sets.v1.schema.json';
