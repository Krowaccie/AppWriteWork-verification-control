...
import { consumeRunnerRequest } from '../../verification/adapters/test-cloud/test-cloud-control-store.mjs';
...
const protocolRoot = fileURLToPath(new URL('../appwrite-runner/protocol/', import.meta.url));
