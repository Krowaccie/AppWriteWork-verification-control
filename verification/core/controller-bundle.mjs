...
function validSeedSourceSetReference(value) {
  return exactDataObject(value, SEED_SOURCE_SET_REFERENCE_KEYS)
    ...
    && value.path === 'verification/controller/controller-seed-source-sets.v1.json'
    && value.schemaPath === 'verification/schemas/controller-seed-source-sets.v1.schema.json';
}
