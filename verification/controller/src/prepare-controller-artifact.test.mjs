...
const ENTRYPOINT = 'verification/controller/src/create-production-browser-policy.mjs';
const SCHEMA = 'verification/schemas/production-browser-policy.v1.schema.json';
...
function verifierFixture() {
  ...
  const proposalPath = path.join(
    root,
    'verification/controller/controller-bundle.proposal.json',
  );
