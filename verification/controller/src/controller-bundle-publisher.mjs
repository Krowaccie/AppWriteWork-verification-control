...
} from '../../core/controller-trust-materials.mjs';
...
const MANIFEST_PATH = 'verification/controller/controller-bundle.manifest.json';
...
export async function runControllerBundlePublisherCli(argv = process.argv.slice(2), environment = process.env) {
  ...
  try {
    ...
    const proposalPath = 'verification/controller/controller-bundle.proposal.json';
    ...
    const evaluatorPaths = [
      'verification/core/bootstrap/qualify-runner.mjs',
      'verification/core/canonical-json.mjs',
      'verification/core/controller-bundle.mjs',
      'verification/core/controller-trust-materials.mjs',
      'verification/adapters/test-cloud/test-cloud-bootstrap.mjs',
    ...
    const publication = await buildControllerBundlePublication({
      ...
      primaryExecutionRetentionMaxSeconds: descriptor.primaryExecutionRetentionMaxSeconds,
      evaluatorClosure: {
        entrypoint: 'verification/core/controller-trust-materials.mjs',
