...
async function loadProducer({ commits, installResult }) {
  ...
  const rewritten = source
    .replace("../../../verification/adapters/test-cloud/test-cloud-control-runtime.mjs", controlUrl)
    .replace("../../../verification/adapters/test-cloud/test-cloud-provider-contract.mjs", providerUrl)
    .replace("../../core/canonical-json.mjs", new URL('../../core/canonical-json.mjs', import.meta.url).href)
    .replace("../../appwrite-runner/provider-contract/test-cloud.provider-contract.v1.json", new URL('../../appwrite-runner/provider-contract/test-cloud.provider-contract.v1.json', import.meta.url).href);
