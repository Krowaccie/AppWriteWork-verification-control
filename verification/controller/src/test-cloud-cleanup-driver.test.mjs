...
import { createTestCloudClients } from '../../../verification/adapters/test-cloud/test-cloud-appwrite.mjs';
import {
...
} from '../../../verification/adapters/test-cloud/test-cloud-control-test-helper.mjs';
...
const controlStoreUrl = new URL(
  '../../../verification/adapters/test-cloud/test-cloud-control-store.mjs',
  import.meta.url,
);
const syntheticControlFacade = dataModule(`
  import { loadSyntheticControlModule } from ${JSON.stringify(
    new URL('../../../verification/adapters/test-cloud/test-cloud-control-test-helper.mjs', import.meta.url).href,
  )};
