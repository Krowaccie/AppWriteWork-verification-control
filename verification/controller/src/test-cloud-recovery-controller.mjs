...
import { RECOVERY_COUNTS } from '../../../verification/adapters/test-cloud/test-cloud-cleanup-protocol.mjs';
import {
  createTestCloudRecoveryClients,
  isAuthenticTestCloudRecoveryControlClient,
  isAuthenticTestCloudRecoveryProductClient,
} from '../../../verification/adapters/test-cloud/test-cloud-appwrite.mjs';
...
} from '../../../verification/adapters/test-cloud/test-cloud-control-store.mjs';
import {
  createRecoveryResourceExecutor,
  recoverTestCloud,
} from '../../../verification/adapters/test-cloud/test-cloud-recovery.mjs';
...
const ADOPTION_STORE_DIAGNOSTIC_MAP = Object.freeze(new Map([
  ['AUDIT_CHAIN_MISMATCH', 'RECOVERY_ADOPTION_AUDIT_CHAIN_MISMATCH'],
  ['LEASE_READBACK_MISMATCH', 'RECOVERY_ADOPTION_LEASE_READBACK_MISMATCH'],
  ['LEASE_VERSION_MISMATCH', 'RECOVERY_ADOPTION_LEASE_VERSION_MISMATCH'],
  ['RECOVERY_SOURCE_AUDIT_PROOF_INVALID', 'RECOVERY_ADOPTION_SOURCE_AUDIT_PROOF_INVALID'],
  ['RECOVERY_SOURCE_INTENT_PROOF_INVALID', 'RECOVERY_ADOPTION_SOURCE_INTENT_PROOF_INVALID'],
  ['RECOVERY_SOURCE_NOT_SAFE_EMPTY', 'RECOVERY_ADOPTION_SOURCE_NOT_SAFE_EMPTY'],
  ['RECOVERY_SOURCE_OWNER_INVALID', 'RECOVERY_ADOPTION_SOURCE_OWNER_INVALID'],
  ['TEST_CLOUD_SETUP_INCOMPLETE', 'RECOVERY_ADOPTION_SETUP_INCOMPLETE'],
