...
const SAFE_BINDING_DIAGNOSTIC_CODES = new Set([
  'APPWRITE_TEST_BINDING_BROWSER_POLICY_INVALID',
  'APPWRITE_TEST_BINDING_INPUT_INVALID',
  'APPWRITE_TEST_BINDING_INVALID',
  'APPWRITE_TEST_BINDING_HOSTED_ATTESTATION_INVALID',
  'APPWRITE_TEST_BINDING_HOSTED_READBACK_INVALID',
  'APPWRITE_TEST_BINDING_OUTPUT_INVALID',
  'APPWRITE_TEST_BINDING_RUNNER_VARIABLES_INVALID',
  'APPWRITE_TEST_BINDING_SETUP_ATTESTATION_INVALID',
  'APPWRITE_TEST_BINDING_SETUP_DOCUMENT_INVALID',
  'APPWRITE_TEST_BINDING_SETUP_READBACK_INVALID',
