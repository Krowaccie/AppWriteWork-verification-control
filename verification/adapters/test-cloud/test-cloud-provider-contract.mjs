...
const TEST_CLOUD_PROVIDER_CONTRACT_DATA_URL = import.meta.resolve('../../appwrite-runner/provider-contract/test-cloud.provider-contract.v1.json');
...
const TEST_CLOUD_BROWSER_ROUTE_ADAPTER_URL = import.meta.resolve('../../controller/src/test-cloud-browser-route-adapter.mjs');
const TEST_CLOUD_BROWSER_ARTIFACT_SET_URL = import.meta.resolve('../../controller/src/test-cloud-browser-artifact-set.mjs');
const TEST_CLOUD_FIXTURE_CLOCK_URL = import.meta.resolve('../../controller/src/test-cloud-fixture-clock.mjs');
