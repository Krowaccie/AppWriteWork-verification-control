...
import closedInventory from '../../fixtures/environments/test-cloud.inventory.v1.json' with {
  type: 'json',
};
...
const PRODUCT_FUNCTIONS_DIGEST =
  'sha256:3b2bbb7500029c6a1e97e6bd8aef76901fa8b87c47e2e66d09c1c1076d9adee0';
