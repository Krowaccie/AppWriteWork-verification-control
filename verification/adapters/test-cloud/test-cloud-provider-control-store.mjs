...
import providerContract from '../../appwrite-runner/provider-contract/test-cloud.provider-contract.v1.json' with { type: 'json' };
...
const RECOVERY_ADOPTION_PROOF_DIAGNOSTICS = Object.freeze(new Map([
  ...
  ['Ordinary audit evidence follows recovery.', 'RECOVERY_SOURCE_AUDIT_ORDER_INVALID'],
  ['Recovery source lease acquisition is invalid.', 'RECOVERY_SOURCE_LEASE_ACQUISITION_INVALID'],
  ['Recovery source run chain is invalid.', 'RECOVERY_SOURCE_RUN_CHAIN_INVALID'],
  ['Recovery source lease renewal is invalid.', 'RECOVERY_SOURCE_LEASE_RENEWAL_INVALID'],
  ['Recovery source cleanup debt is invalid.', 'RECOVERY_SOURCE_CLEANUP_DEBT_INVALID'],
  ['Recovery source lease recovery is invalid.', 'RECOVERY_SOURCE_LEASE_RECOVERY_INVALID'],
  ['Recovery source lease close is invalid.', 'RECOVERY_SOURCE_LEASE_CLOSE_INVALID'],
  ['Recovery event run is invalid.', 'RECOVERY_EVENT_RUN_INVALID'],
  ['Recovery source lease state is invalid.', 'RECOVERY_SOURCE_LEASE_STATE_INVALID'],
  ['Recovery genesis proof is invalid.', 'RECOVERY_GENESIS_PROOF_INVALID'],
  ['Recovery terminal intent proof is invalid.', 'RECOVERY_TERMINAL_INTENT_PROOF_INVALID'],
  ['Recovery event snapshot is invalid.', 'RECOVERY_EVENT_SNAPSHOT_INVALID'],
  ['Recovery successor source proof is invalid.', 'RECOVERY_SUCCESSOR_SOURCE_PROOF_INVALID'],
  ['Recovery lease state is invalid.', 'RECOVERY_LEASE_STATE_INVALID'],
]));
